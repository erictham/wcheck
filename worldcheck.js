...
/* .......................................................................... */
 ...
 /*   if( n.cover )
    ...
    info +=
    '<img src="imgs/close.png" class="action" style="top: 0px;" title="close panel" onClick="toggleDiv(\'movieInfo\');"/>' +
    '<img src="imgs/target-32.png" class="action" style="top: 280px;" title="center graph on movie" onclick="selectMovie('+n.index+',true);"/>';
	
    info += '<br/></div><div style="clear: both;">'
    if( n.label )
      info += '<div class=f><span class=l>Label</span>: <span class=g>' 
           + n.label + '</span></div>';
	if( n.level )
      info += '<div class=f><span class=l>Relationship Level</span>: <span class=d>' 
           + n.level + '</span></div>';
    if( n.type )
      info += '<div class=f><span class=l>Entity Type</span>: <span class=d>' 
           + n.type + '</span></div>';
	if( n.uris )
      info += '<div class=f><span class=l>DataFusion Reference</span>: <span class=d>' 
           + n.uris + '</span></div>';
    if( n.score )
      info += '<div class=f><span class=l>Score</span>: <span class=c>' 
           + n.score + '</span></div>';
    if( n.links ) {
...
//});
    ...
    var graphNodes = networkGraph.append('svg:g').attr('class','grp gNodes')
	  ...
	  .attr('wc', function(d) { return 'node wc'+d.wc;} )		// this is to highlight WC nodes
